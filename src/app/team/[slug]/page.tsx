...
const BIOS: Record<string, {
  ...
  ai: {
    ...
    bio: [
      'Tamie Stephen is a specialist in AI governance and data strategy, advising board-level clients on responsible AI adoption and policy frameworks.',
      'With a background spanning data science, technology strategy, and organisational risk, Tamie brings a distinctive perspective to AI strategy engagements — combining technical depth with an understanding of how organisations actually make decisions.',
      "Tamie leads DeepSlate's AI strategy practice, working with executive teams to navigate the rapidly evolving AI landscape — from initial readiness assessment through to governance framework development and ongoing advisory.",
    ],
